 ...
 */
final class Version20230707141705 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prestation DROP total_ht');
        $this->addSql('ALTER TABLE prestation DROP total_tva');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE invoice_product (id INT NOT NULL, invoice_id INT NOT NULL, product_id INT NOT NULL, total INT NOT NULL, quantity INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE prestation ADD total_ht NUMERIC(5, 2) NOT NULL');
        $this->addSql('ALTER TABLE prestation ADD total_tva NUMERIC(5, 2) NOT NULL');
